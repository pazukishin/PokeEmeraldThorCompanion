...
object EmeraldMapContentCatalog {
    private val items = mapOf(
        "MAP_ROUTE_102" to listOf(MapItem("Poción", spriteKey = "potion"), MapItem("Baya Aranja", spriteKey = "oran-berry"), MapItem("Baya Meloc", spriteKey = "pecha-berry")),
        "MAP_ROUTE_103" to listOf(
